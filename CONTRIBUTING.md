Contributing to TICO Core
============================

The TICO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TICO Core project, and is not to be
confused with overall TICO Network Protocol consensus changes.

Whether a pull request is merged into TICO Core rests with the project merge
...
Patches that change TICO consensus rules are considerably more involved than
...
Where a patch set proposes to change the TICO consensus, it must have been
...
The project leader is the release manager for each TICO Core release.
