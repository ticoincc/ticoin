...
Setup
---------
Configuring the github-merge tool for the TICO repository is done in the following way:

    git config githubmerge.repository TICO-Project/TICO
...
A script to optimize png files in the TICO
