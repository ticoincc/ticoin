...
RESOURCES += src/qt/ticoin.qrc src/qt/ticoin_locale.qrc

TRANSLATIONS += src/qt/locale/ticoin_bg.ts \
                src/qt/locale/ticoin_de.ts \
                src/qt/locale/ticoin_en.ts \
                src/qt/locale/ticoin_es.ts \
                src/qt/locale/ticoin_fi.ts \
                src/qt/locale/ticoin_fr.ts \
                src/qt/locale/ticoin_it.ts \
                src/qt/locale/ticoin_ja.ts \
                src/qt/locale/ticoin_pl.ts \
                src/qt/locale/ticoin_pt.ts \
                src/qt/locale/ticoin_ru.ts \
                src/qt/locale/ticoin_sk.ts \
                src/qt/locale/ticoin_sv.ts \
                src/qt/locale/ticoin_vi.ts \
                src/qt/locale/ticoin_zh_CN.ts \
                src/qt/locale/ticoin_zh_TW.ts
