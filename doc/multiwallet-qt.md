...
In order to support loading of multiple wallets in ticoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ticoin.cpp.
...
Changes to ticoin.cpp
----------------------
ticoin.cpp is the entry point into ticoin-qt, and as such, will require some minor modifications to provide hooks for
