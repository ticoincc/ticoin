...
This mechanism has been integrated into Bitcore-Node-TICO which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TICO-Project/insight-api-ticoin#web-socket-api](https://github.com/TICO-Project/insight-api-ticoin#web-socket-api) 
* API: [https://github.com/TICO-Project/insight-api-ticoin#swifttx-transactions](https://github.com/TICO-Project/insight-api-ticoin#swifttx-transactions) 
...
By default, the TICO Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TICO Core daemon:
