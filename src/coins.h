...
/** 
    ...
    ****Note - for TICO we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of ticoin coming in to a transaction
