...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total ticoin balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zTICOsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zTICO denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zTICO denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zTICO denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zTICO denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zTICO denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zTICO denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zTICO denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zTICO denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zTICO denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in ticoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in ticoin/kb\n"
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zticoinObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zticoinObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zTICOsupply", zticoinObj));
...
#ifdef ENABLE_WALLET
        // Case 1: TICO address and we have full public key:
