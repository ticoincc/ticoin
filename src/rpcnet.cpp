...
Value getpeerinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"subver\": \"/Ticoin Core:x.x.x.x/\",  (string) The string version\n"
...
Value addnode(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2 ||
        ...
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("addnode", "\"192.168.0.6:45022\" \"onetry\"") + HelpExampleRpc("addnode", "\"192.168.0.6:45022\", \"onetry\""));
...
Value getaddednodeinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "    \"addresses\" : [\n"
            "       {\n"
            "         \"address\" : \"192.168.0.201:45022\",  (string) The ticoin server host and port\n"
...
Value getnetworkinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"subversion\": \"/Ticoin Core:x.x.x.x/\",     (string) the server subversion string\n"
            ...
            "  ,...\n"
            "  ],\n"
            "  \"relayfee\": x.xxxxxxxx,                (numeric) minimum relay fee for non-free transactions in ticoin/kb\n"
