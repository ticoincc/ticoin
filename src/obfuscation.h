...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 TICO - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of ticoin.
