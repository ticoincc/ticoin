...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ticoin Core ticoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ticoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ticoin transaction") + "\n" +
                               "  ticoin-tx [options] -create [commands]   " + _("Create hex-encoded ticoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ticoin transaction
