                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Ticoin from zTicoin"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTicoin"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTicoin));
