...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Ticoin to zTicoin");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zTicoin");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Ticoin from zTicoin");
    case TransactionRecord::ZerocoinSpend_Change_zTicoin:
        return tr("Minted Change as zTicoin from zTicoin Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zTicoin to Ticoin");
