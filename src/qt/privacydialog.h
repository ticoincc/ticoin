...
public:
    ...
    void setZTicoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzTICO_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzTICO_clicked();
    void on_pushButtonZTicoinControl_clicked();
