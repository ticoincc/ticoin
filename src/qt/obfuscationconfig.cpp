...
void ObfuscationConfig::clickBasic()
{
    ...
    QMessageBox::information(this, tr("Obfuscation Configuration"),
        tr(
            "Obfuscation was successfully set to basic (%1 and 2 rounds). You can change this at any time by opening TICO's configuration screen.")
            .arg(strAmount));
...
void ObfuscationConfig::clickHigh()
{
    ...
    QMessageBox::information(this, tr("Obfuscation Configuration"),
        tr(
            "Obfuscation was successfully set to high (%1 and 8 rounds). You can change this at any time by opening TICO's configuration screen.")
            .arg(strAmount));
...
void ObfuscationConfig::clickMax()
{
    ...
    QMessageBox::information(this, tr("Obfuscation Configuration"),
        tr(
            "Obfuscation was successfully set to maximum (%1 and 16 rounds). You can change this at any time by opening TICO's configuration screen.")
            .arg(strAmount));
...
void ObfuscationConfig::configure(bool enabled, int coins, int rounds)
{
    ...
    settings.setValue("nAnonymizeTicoinAmount", coins);

    nZeromintPercentage = rounds;
    nAnonymizeTicoinAmount = coins;
}
