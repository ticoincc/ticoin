                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TICO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TICO address"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTICO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TICO Core"), this);
    aboutAction->setStatusTip(tr("Show information about TICO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TICO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TICO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TICO addresses"));
    ...
    openAction->setStatusTip(tr("Open a TICO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TICO Core help message to get a list with possible TICO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TICO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TICO network", "", count));
}
...
{
    QString strTitle = tr("TICO Core"); // default title
