...
/** Utility functions used by the TICO Qt UI.
 */
namespace GUIUtil
{
...
// Render TICO addresses in monospace font
...
// Parse "ticoin:" URI into recipient object, return true on successful parsing
