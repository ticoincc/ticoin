...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ticoin features */
        {"ticoin", "masternode", &masternode, true, true, false},
        {"ticoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ticoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ticoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ticoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ticoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ticoin", "startmasternode", &startmasternode, true, true, false},
        {"ticoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ticoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ticoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ticoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ticoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ticoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ticoin", "mnbudget", &mnbudget, true, true, false},
        {"ticoin", "preparebudget", &preparebudget, true, true, false},
        {"ticoin", "submitbudget", &submitbudget, true, true, false},
        {"ticoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ticoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ticoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ticoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ticoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ticoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ticoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ticoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ticoin", "mnsync", &mnsync, true, true, false},
        {"ticoin", "spork", &spork, true, true, false},
        {"ticoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ticoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ticoind, or the -server option to ticoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:45023/\n";
}
