...
#   c) node1 mines 32 blocks, so now node 0 has 60001ticoin, node 1 has 4250ticoin, node2 has none.
#   d) node0 sends 601 ticoin to node2, in two transactions (301 ticoin, then 300 ticoin).
